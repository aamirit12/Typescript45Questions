...
let author = "Albert Enstein";
console.log(`${author} once said, "${quote}"`);
// Q:no 5
// Famous quote 2: Repeat Exercise 4, but this time  store the famous person's name in a variable called famous_person.Then compose your message and store it in a new variable called message.Print your message.
// Answer
let person_name = "Albert Enstein";
let message = `${person_name} once said, "A person who never made a mistake never tried anything new."`;
console.log(message);
// Q:no 6
...
let message = `I like ${favoriteNumber} number because it's My lucky number.`;
console.log(message);
// Q:no 10
...
// Answer
let names = ["Aamir", "Ab Rehman", "Hafeez", "Rehan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
// Answer
let names = ["Aamir", "Ab Rehman", "Hafeez", "Rehan"];
let message = " Would like to take a cup of tea?";
...
while (guestList.length > 2) {
    ...
    if (RemovedGuests !== undefined) {
        console.log(`sorry ${RemovedGuests} we can't invit you`);
    }
    ;
}
// // // task 3
...
// // Answer
let fivePlaces = ["Bumbai", "Dubai", "Arab", "New york"];
// // • Print your array in its original order.
...
// Answer
let mountains = ["K2", "Karakarm", "Everest", "koh e toor"];
...
if (alien_colors == "green") {
    console.log("pass the if test");
}
else { }
// // fails the it test
let aliens_colors = "green";
if (aliens_colors == "white") {
    console.log("pass the if test");
}
else { }
// Q:no 26
...
if (favorite_fruits.includes("Apple")) {
    console.log("i would to Like to eat Apple");
}
else if (favorite_fruits.includes("Mango")) {
    console.log("i would to Like to eat Mango");
}
...
if (favorite_fruits.includes(fruitavailable)) {
    console.log(`i would to Like to eat ${fruitavailable}`);
}
else {
    console.log(`${fruitavailable} is not available in your list`);
}
// // Q:no 30
...
//answer
let usernames = ["Eric", "Asif", "admin", "Imran", "Ali"];
...
// // answer
// • Make a list of five or more usernames called current_users.
let current_users = ["Aamir", "Imran", "Asif", "Nisar"];
// // • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["rehman", "imran"];
...
let pizza = ["spicy pizza", "hot pizza", "pepperoni pizza"];
...
let animals = ["Goat", "Dog", "Sheep"];
animals.forEach(comman => {
    console.log(`A ${comman} would make a great pet`);
});
...
function make_shirt(size, message) {
    console.log(`You have ordered "${size}" size T-shirt on that "${message}" message is printed `);
}
...
const magician = ["Ali", "Rehman", "Rehan"];
...
const magician2 = ["Aamir", "Ali", "rehman"];
const greatmagician1 = make_great1(magician2);
